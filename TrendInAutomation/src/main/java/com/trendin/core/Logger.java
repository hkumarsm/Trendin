...
public class Logger {
	...
	public static enum LogLevel {
		...
		private static LogLevel[] lvls = { off, fatal, error, warn, info,
				debug, trace };
	...
	// log pointer
	public void trace(String pointer) {
	...
	// log info
	public void info(String pointer) {
		log.info(pointer);
	}

	// log debug
	public void debug(String pointer) {

		log.debug(pointer);
	}

	// log fatal errors
	public void fatal(String pointer) {

		log.fatal(pointer);
	}

	// log warning errors
	public void warning(String pointer) {
		log.warn(pointer);
	}

	// log errors
	public void error(String pointer) {
		log.error(pointer);
	}
