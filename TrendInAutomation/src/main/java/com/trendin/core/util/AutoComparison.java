...
import com.trendin.core.util.datadriver.DataDriverBuilder;
...
public class AutoComparison 
{
	...
	public static void RSDataComparison(String file, ResultSet rs) throws SQLException
	{
        ...
        data = (DataDriverBuilder) DataDriverFactory.create(file);
		...
		{	
			...
			while(((DataDriver) data).hasNext() && !found)
			{
				//Iterates over data set row
				String[] dArray = ((DataDriver) data).next();
