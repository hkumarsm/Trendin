...
/**
 * Closeable Workbook class, so that the file handle for the workbook can be
 * closed.
 * 
...
public class CloseableWorkbook implements Closeable, Workbook {
	 ...
	 *            The Workbook
	 * @param file
	 *            The file handler for the workbook.
	 */
	...
	@Override
	public Font findFont(short arg0, short arg1, short arg2, String arg3, boolean arg4, boolean arg5, short arg6, byte arg7) {
	...
	public int linkExternalWorkbook(String arg0, Workbook arg1) {
		int ret = ((CloseableWorkbook) wb).linkExternalWorkbook(arg0, arg1);
		return ret;
	}
