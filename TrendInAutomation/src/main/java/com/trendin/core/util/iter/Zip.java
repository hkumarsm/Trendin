package com.trendin.core.util.iter;
...
import com.trendin.core.util.iter.arrays.ArrayIterableFactory;

/**
 * 
 * @author Brian Van Stone
 *
 * @param <T> The type of data contained in the collections, iterables, or iterators to zip
 */
